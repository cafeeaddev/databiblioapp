...
class BookDetails1CategoryComponent extends StatelessWidget {
  ...
  BookDetails1CategoryComponent(
      {this.bookDetailResponse, this.isCenterInfo = false});
  ...
  Widget build(BuildContext context) {
    if (isWeb) {
      return Column(
        ...
        children: [
          Row(
            crossAxisAlignment: isCenterInfo!
                ? CrossAxisAlignment.center
                : CrossAxisAlignment.start,
            mainAxisAlignment: isCenterInfo!
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  8.height,
                  Text(bookDetailResponse!.categoryName.validate(),
              ...
              Column(
                ...
                children: [
                  ...
                  PriceComponent(
                    ...
                    discountedPrice:
                        bookDetailResponse!.discountedPrice.validate(),
