        ...
        children: [
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment:
                    widget.isCenterBookInfo! ? CrossAxisAlignment.center : CrossAxisAlignment.start,
                children: [
                  Stack(
                    children: [
                      InkWellWidget(
                        image: widget.bookData!.frontCover
                            .validate(value: bookFrontCoverIfCoverNotAvailable),
                        onTap: () {
                          if (isMobile) {
                            if (appStore.pageVariant == 1) {
                              BookDetailsScreen1(
                                      bookId: widget.bookData!.bookId.validate(),
                                      bookDetailResponse: widget.bookData)
                                  .launch(context);
                            } else {
                              BookDetailsScreen2(bookId: widget.bookData!.bookId.validate())
                                  .launch(context);
                            }
                          } else {
                            BookDetailsScreen1(
                      ...
                      Positioned(
                        ...
                        child: IconButton(
                          ...
                          color: redColor,
                          icon: widget.bookData!.isWishlist == 0
                          ...
                          onPressed: () async {
                            showConfirmDialogCustom(
                              ...
                              onAccept: (BuildContext context) async {
                                await addRemoveWishListApi(widget.bookData!.bookId.validate(),
                                        widget.bookData!.isWishlist == 0 ? 1 : 0)
                                    .then(
                                  (value) {
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        8.height,
                        Text(widget.bookData!.authorName.validate(),
