...
class WebChallengesFragmentScreen extends StatefulWidget {
  @override
  _WebChallengesFragmentScreenState createState() =>
      _WebChallengesFragmentScreenState();
}

class _WebChallengesFragmentScreenState
    extends State<WebChallengesFragmentScreen> {
  @override
  void initState() {
    super.initState();
    init();
    ...
    return Observer(builder: (context) {
      return SingleChildScrollView(
        child: NoDataWidget(
          ...
          titleTextStyle:
              boldTextStyle(color: appStore.isDarkMode ? Colors.white : null),
                ...
                return SliverAppBar(
                  ...
                  bottom: TabBar(
                    ...
                    unselectedLabelColor:
                        appStore.isDarkMode ? white : blackColor,
