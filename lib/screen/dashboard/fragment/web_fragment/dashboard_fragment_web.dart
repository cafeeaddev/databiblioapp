...
class WebDashboardFragment extends StatelessWidget {
  final DashboardResponse? data;

  WebDashboardFragment({this.data});
          ...
          Column(
            ...
            children: [
              ...
              SeeAllComponent(
                ...
                isShowSeeAll: data!.categoryBook!.length > 15 ? true : false,
                onClick: () {
              ...
              ///Top Search Book
              if (data!.topSearchBook!.isNotEmpty) 40.height,
              SeeAllComponent(
              ...
              ///Recommended Books
              if (data!.recommendedBook!.isNotEmpty) 40.height,
              SeeAllComponent(
